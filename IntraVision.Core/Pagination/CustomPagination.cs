...
namespace IntraVision.Core.Pagination
{
	...
	public class CustomPagination<T> : IPagination<T>
	{
        ...
        /// <param name="pagesOnPage">The count pages on page</param>
		public CustomPagination(IEnumerable<T> dataSource, int pageNumber, int pageSize, int totalItems, int pagesOnPage)
		{
